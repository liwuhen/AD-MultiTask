...
#ifndef APP_MULTITASK_TRT_HIGH_INFER_H__
#define APP_MULTITASK_TRT_HIGH_INFER_H__
...
/**
 * @class TrtHighVersionInfer.
 * @brief Trt high version model infer.
 */
class TrtHighVersionInfer : public BackendModuleBase {
 public:
  TrtHighVersionInfer();
  ~TrtHighVersionInfer();
...
#endif  // APP_MULTITASK_TRT_HIGH_INFER_H__
