...
export LD_LIBRARY_PATH=$INSTALL_PATH/backend:$LD_LIBRARY_PATH
export LD_LIBRARY_PATH=$THIRD_PARTY/opencv:$TENSORRT/lib:$LD_LIBRARY_PATH
export LD_LIBRARY_PATH=$INSTALL_PATH/preprocessor:$INSTALL_PATH/postprecessor:$INSTALL_PATH/libs:$LD_LIBRARY_PATH
